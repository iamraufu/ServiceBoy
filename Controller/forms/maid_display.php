...
<body>
 ...
 <td> <button class="btn-primary btn"> <a href="maid_update.php?maidid=<?php echo $res['maidid']; ?>" class="text-white"> Update </a>  </button> </td>
 <td> <button class="btn-danger btn"> <a href="maid_delete.php?maidid=<?php echo $res['maidid']; ?>" class="text-white"> Delete </a> </button> </td>
